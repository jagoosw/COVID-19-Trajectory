...
###**** Settings ***
num_days = 7 #The number of days the new cases are counted over
...
selection = ["China","United States","Belgium","Austria","France","United Kingdom", "Italy","Sweden","South Korea","Austria"] #The contries you want to see if not all
quarantines= {"2020-03-26":"United Kingdom","2020-02-22":"South Korea","2020-03-10":"Italy","2020-03-19":"Austria"} #The days lockdown started in different contries
...
if show_quarantine == True:
    plt.text(0.95, 0.03,'Red dot shows the \nstart of/changes to\n lockdowns', horizontalalignment='center', verticalalignment='center', transform = ax.transAxes)

plt.show()

print("Max UK:",max(data_week["United Kingdom"]))
print("on",data_week["United Kingdom"].index(max(data_week["United Kingdom"])))
